                                    ...
                                    <CardFooter>
                                        ...
                                        <Typography variant="small" className="mt-6 flex justify-center">
                                            ...
                                            <Typography
                                                ...
                                                onClick={handleOpen}
                                            >
                                                {/* <button onClick={() => setIsLoginVisible(false)}>Login</button> */}
                                                <button onClick={toggleForm}>
                                                    {isLoginVisible ? 'Criar uma conta' : 'Já tenho uma conta'}
                                                </button>
                                            </Typography>
                                        </Typography>
                                    </CardFooter>
                                    ...
                                    <CardFooter>
                                        ...
                                        <Typography variant="small" className="mt-6 flex justify-center">
                                            <Typography
                                                ...
                                                onClick={handleOpen}
                                            >
                                                {/* <button onClick={() => setIsLoginVisible(true)}>CADASTRE-SE</button> */}
                                                <button onClick={toggleForm}>
                                                    {isLoginVisible ? 'Criar uma conta' : 'Já tenho uma conta'}
                                                </button>
                                            </Typography>
